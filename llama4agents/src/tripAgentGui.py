    ...
    with gr.Row():
        with gr.Column(scale=1):
            destination = gr.Textbox(
                label="Destination", placeholder="London, UK", value="London, UK"
            )
            dates = gr.Textbox(
                label="Travel Dates",
                placeholder="August 15-22, 2024",
                value="August 15-22, 2024",
            )
            budget = gr.Textbox(
                label="Budget",
                placeholder="Mid-range (£1000-£1500)",
                value="Mid-range (£1000-£1500)",
            )
